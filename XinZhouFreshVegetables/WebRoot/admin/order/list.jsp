								...
								<c:forEach items="${allOrders}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="/XinZhouFreshVegetables/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}">发货</a>
												</c:if>
												<c:if test="${o.state==3}">已发货  <a href="/XinZhouFreshVegetables/AdminOrderServlet?method=updateOrderByOidOk&oid=${o.oid}">完成</a></c:if>
...
$(function(){
	...
	$(".myClass").click(function(){
		...
		if(txt=="订单详情"){
			...
			var url="/XinZhouFreshVegetables/AdminOrderServlet";
			...
			$.post(url,obj,function(data){
				...
				$.each(data,function(i,obj){
					var td="<tr><td><img src='/XinZhouFreshVegetables/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
					$tb.append(td);				
				})
			},"json");
