...
public class AdminOrderServlet extends BaseServlet {
	...
	public String updateOrderByOid(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		//重新定向到查询已发货订单
		resp.sendRedirect("/XinZhouFreshVegetables/AdminOrderServlet?method=findOrders&state=3");
		return null;
	}	
	
	//updateOrderByOid
		public String updateOrderByOidOk(HttpServletRequest req, HttpServletResponse resp) throws Exception {
			//获取订单ID
			String oid=req.getParameter("oid");
			//根据订单ID查询订单
			OrderService OrderService=new OrderServiceImp();
			...
			//修改订单信息
			OrderService.updateOrder(order);
			resp.sendRedirect("/XinZhouFreshVegetables/AdminOrderServlet?method=findOrders&state=4");
			return null;
		}	
